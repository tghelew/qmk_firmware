 ...
 * |--------+------+------+------+------+------| L2   |           | L2   |------+------+------+------+------+--------|
 * |M-LShift|   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | M-AltGr|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |C-Shift|  `  |  '   |Lft/L2|Rht/L1|                                       |Up/L1 |Down/L2| [   |   ]   |C-Shift|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  | Home |       | PgUp  |SysRq|
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LALT(KC_LSFT), CTL_T(KC_Z),  KC_X,       KC_C,  KC_V,   KC_B,   TG(MDIA),
        LCTL(KC_LALT), KC_GRAVE,     KC_QUOTE,   LT(MDIA,KC_LEFT), LT(SYMB,KC_RIGHT),
                                                 KC_DEL,  KC_HOME,
                                                          KC_END,
                                                 CTL_T(KC_SPC),ALT_T(KC_BSPC),KC_LGUI,
        // right hand
             ...
             KC_PGUP,        KC_PSCREEN,
             KC_PGDN,
             KC_RALT,ALT_T(KC_ENTER), CTL_T(KC_SPC)
    ),
...
[MDIA] = KEYMAP(
    ...
    // right hand
       ...
       _______,  _______, KC_VOLU, KC_MPLY, KC_VOLD, _______, _______,
                 _______, KC_MPRV, KC_MUTE, KC_MNXT, _______, _______,
